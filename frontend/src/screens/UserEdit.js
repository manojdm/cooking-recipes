...
import { EDIT_USER_RESET, FETCH_USERS_RESET, FETCH_USER_RESET } from '../constants/userConstants';
...
const UserEdit = ({history , match}) => {
    ...
    return (
        <section id="userEdit">
            ...
            <button onClick={addUserHandler} className="submit">Update User</button>
        </section>
    )
}
